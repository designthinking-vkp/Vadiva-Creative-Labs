/**
 * Razorpay Standard Checkout Helper Module ($2 USD)
 * Includes Google Apps Script integration & PDF Receipt Generator
 */
(function(window) {
  'use strict';
  ...
  async function initiateRazorpayCheckout(options = {}) {
    ...
    try {
      ...
      const checkoutOptions = {
        ...
        image: options.image || (window.CAMPAIGN_CONFIG ? window.CAMPAIGN_CONFIG.getLogo(null, '/') : '/assets/logo.png'),
        order_id: order.id,
        ...
        <div id="receipt-pdf-render-area" style="background: #ffffff; padding: 2rem; color: #0f172a;">
          ...
          <div style="display: flex; justify-content: space-between; align-items: center; padding-bottom: 1.25rem; border-bottom: 2px solid #f1f5f9; margin-bottom: 1.5rem;">
            <div style="display: flex; align-items: center; gap: 0.75rem;">
              <img src="${window.CAMPAIGN_CONFIG ? window.CAMPAIGN_CONFIG.getLogo() : 'assets/logo.png'}" alt="Vadiva Logo" style="height: 44px; width: auto; max-width: 150px; object-fit: contain;">
            </div>
